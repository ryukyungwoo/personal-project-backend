...
이 프로젝트는 사용자가 산란 되어있는 주식 정보를 집중 할 수 있게 하고<br />

집중한 정보를 비교, 토론할 수 있는 "실시간 주식 정보 통합 플랫폼"을 목표로 했습니다. <br />

파이썬으로 주식 정보와 뉴스를 수집하고 네이버 주식 게시판을 분석하여 여론을 정확히 파악할 수 있게 했습니다. <br />

또한, 게시판과 실시간 채팅 기능을 통해 사용자들이 얻은 정보를 통해 의견을 교류 할 수 있게 하였습니다.<br />

그렇게 통합적인 정보, 의견을 바탕으로 사용자의 거래 결정을 도와주는 것이 이 프로젝트의 기획 의도 입니다.<br />
...
![image](https://github.com/ryukyungwoo/D-YES-Backend/assets/128555353/578f620b-bdad-495f-a0e8-38be44b33558) <br />
...
![image](https://github.com/ryukyungwoo/D-YES-Backend/assets/128555353/43bd42de-2708-4300-bc99-f71d1df4a376) <br />
...
![image](https://github.com/ryukyungwoo/D-YES-Backend/assets/128555353/17b8ecdb-c1b3-4953-8292-d84316b1b7af) <br />
...
또한, 스케쥴러나 이니셜라이즈 같은 경우 필요한 의존성을 주입하여 애플리케이션의 로직을 분리하고 관리하기 쉽게 만들었고, 유지 보수성과 확장성을 향상 시켰습니다. <br />
